...
namespace Core.Tests.Linq
{
    ...
    public class SortExpressionTests
    {
        ...
        {
            var result = SortExpression.SortExpression.FromString("Dummy.Dummy");
        ...
        {
            var result = SortExpression.SortExpression.FromString("Dummy.Dummy DESC");
        ...
        {
            var result = SortExpression.SortExpression.FromString("Dummy.Dummy desc"); //Lower case
        ...
        {
            var result = SortExpression.SortExpression.FromString("sortexpr: Dummy");
        ...
        {
            var result = SortExpression.SortExpression.FromString("sortexpr: Dummy DummyParam1 DummyParam2");
        ...
        {
            var result = SortExpression.SortExpression.FromString("sortexpr: Dummy DummyParam1 DummyParam2 DESC");
        ...
        {
            var result = SortExpression.SortExpression.FromString("sortexpr: Dummy DummyParam1 DummyParam2 ASC");
        ...
        {
            var sortExpression = SortExpression.SortExpression.FromString("Integer");
        ...
        {
            var sortExpression = SortExpression.SortExpression.FromString("String");
            var result = _dummies.AsQueryable().OrderBy(sortExpression).ToList();
        ...
        {
            var sortExpression = SortExpression.SortExpression.FromString("Integer DESC");
            var result = _dummies.AsQueryable().OrderBy(sortExpression).ToList();
        ...
        public void Sort_UsingSortExpression_ConstructsProviderWithProperGenerics()
        {
            ...
            _dummies.AsQueryable().OrderBy(SortExpression.SortExpression.FromString("sortexpr: SortDummy"));
        ...
        public void Sort_UsingSortExpression_ConstructsProviderWithProperGenerics2()
        {
            ...
            _dummies.AsQueryable().OrderBy(SortExpression.SortExpression.FromString("sortexpr: NonGenericSortDummy"));
        ...
        {
            var result = _dummies.AsQueryable().OrderBy(SortExpression.SortExpression.FromString("sortexpr: SortDummy")).ToList();
